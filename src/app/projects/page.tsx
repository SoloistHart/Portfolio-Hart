...
export const metadata: Metadata = {
  ...
  description: "Selected project narratives from the Hart portfolio base.",
};
          ...
          <div className="mt-10 grid gap-12 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-end">
            <Reveal>
              <div className="max-w-3xl">
                ...
                <h1 className="mt-5 text-5xl font-semibold tracking-[-0.08em] text-foreground sm:text-6xl">
                  Dedicated project stories with enough structure to grow later.
                </h1>
                <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
                  The archive keeps the same voice as the homepage: premium, readable, and ready for deeper interaction later. Each case study focuses on story, intent, and what makes the work hold up over time.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.08}>
              <div className="panel rounded-[1.7rem] p-6">
                <p className="section-kicker">Built for expansion</p>
                <p className="mt-4 text-sm leading-7 text-muted">
                  Swap placeholder copy, add richer imagery, or grow these into deeper case studies without changing the overall system.
                </p>
                <Link
