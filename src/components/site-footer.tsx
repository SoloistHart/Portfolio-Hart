...
export function SiteFooter() {
  return (
    <footer className="page-shell pb-8 pt-4">
      <div className="rounded-[1.6rem] border border-line bg-surface/50 px-6 py-6 sm:px-7">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <Link href={`mailto:${siteContent.contact.email}`} className="text-sm text-muted hover:text-foreground">
              Email
            </Link>
            <Link
              href="https://github.com/SoloistHart"
              target="_blank"
            ...
            <Link
              href="https://www.linkedin.com/in/rhohart-martel-4798ab307"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted hover:text-foreground"
              aria-label="LinkedIn"
            >
              <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </Link>
          </div>
        </div>
      </div>
